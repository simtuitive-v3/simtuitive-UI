...
export class SignupComponent implements OnInit {
    ...
    this.authService.authState.subscribe((user) => {
      ...
      if (this.loggedIn) {
        ...
        this.loginService.verifyGoogleToken(data).subscribe((res: any) => {
          ...
          err => {
            this.responseErrMsg = 'Google Authentication Failed'
          });
      }
    });
  }
  ...
  signUp() {
    ...
    if (this.password === this.confirmPassword) {
      ...
      this.loginService.createUser(data).subscribe(res => {
        console.log(res)
        this.signupView = false
        this.signupSuccessView = true
      },
        err => {
          const errmsg = JSON.parse(err._body)
          console.log(errmsg.message)
          this.responseErrMsg = errmsg.message
          console.log(this.responseErrMsg)
        })
    }
    else {
      this.responseErrMsg = 'password do not match'
